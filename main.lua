...
--// =========================
--// HC HUB FULL FIX LAYER
--// Keeps original UI & features
--// =========================
...
-- Safe tween
function HC_SAFE_TWEEN(Position, Speed)
    pcall(function()
        ...
        local Tween = TweenService:Create(
            HRP,
            TweenInfo.new(Distance / (Speed or 250), Enum.EasingStyle.Linear),
